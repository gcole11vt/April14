...
urlpatterns = [
    ...
    url(r'^FinData/BenchmarkCharts/completed/$', Tasks_views.completed, name='completed'),
    url(r'^FinData/BenchmarkCharts/$', Tasks_views.findata_benchmarkcharts, name='findata_benchmarkcharts'),
    url(r'^FinData/LoadFiles/completed/$', Tasks_views.completed, name='completed'),
    url(r'^FinData/LoadFiles/$', Tasks_views.findata_LoadFiles, name='findata_loadfiles'),
